...
fun CupcakeApp(
    ...
    Scaffold(
        ...
        NavHost(navController, CupcakeScreen.Start.name, Modifier.padding(innerPadding)) {
            ...
            composable(route = CupcakeScreen.Summary.name){
                ...
                OrderSummaryScreen(
                    ...
                    onSendButtonClicked = {
                        subject: String, summary: String -> shareOrder(context= context, subject = subject, summary = summary)
                    }
                )
            }
        }
